...
export default function PhasesManager({ projectId }: PhasesManagerProps) {
    ...
    return (
        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            ...
            {/* Add New Phase Form */}
            <form onSubmit={handleAddPhase} className="grid grid-cols-1 sm:grid-cols-12 gap-3 pt-4 border-t border-gray-700">
                ...
                <div className="sm:col-span-1">
                    <button
                        ...
                        className="w-full flex items-center justify-center rounded-md bg-yellow-500 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
