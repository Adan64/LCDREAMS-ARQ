      ...
      <footer className="bg-primary text-primary-foreground py-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-headline text-lg font-headline-bold mb-4">ArchiVision</h3>
          ...
          <div className="pt-8 border-t border-primary-foreground/20 text-center">
            <p className="font-body text-sm font-body-regular text-primary-foreground/60">
              © {new Date().getFullYear()} ArchiVision. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
