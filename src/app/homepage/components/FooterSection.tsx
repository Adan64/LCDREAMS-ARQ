  ...
  const footerSections: FooterSection[] = [
    {
      title: "Servicios",
      links: [
        { label: "Diseño Residencial", href: "/services" },
        { label: "Arquitectura Comercial", href: "/services" },
        { label: "Planificación Urbana", href: "/services" },
        { label: "Diseño de Interiores", href: "/services" }
      ]
    },
    {
      title: "Empresa",
    ...
    },
    {
      title: "Legal",
      links: [
        { label: "Política de Privacidad", href: "/homepage" },
        { label: "Términos de Servicio", href: "/homepage" },
        { label: "Cookies", href: "/homepage" },
        { label: "Aviso Legal", href: "/homepage" }
      ]
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="font-body text-base text-lcdream-gray-light font-body-regular leading-relaxed mb-6 max-w-md">
              Transformando espacios con visión y creatividad. Donde la función se encuentra con la belleza para crear resultados extraordinarios.
            </p>
        ...
        <div className="border-t border-lcdream-gold/20 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="font-body text-sm text-lcdream-gray-light font-body-regular text-center md:text-left">
              {isHydrated ? `© ${currentYear}` : '© 2026'} LCDREAM.ARQ. Todos los derechos reservados.
            </p>
