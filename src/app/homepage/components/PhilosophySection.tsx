  ...
  const philosophyPillars: PhilosophyPillar[] = [
    {
      ...
      description: "Transformamos ideas en espacios que inspiran y mejoran la calidad de vida"
    },
    {
      id: 2,
      icon: "SparklesIcon",
      title: "Excelencia Funcional",
      description: "Cada diseño equilibra perfectamente estética y funcionalidad práctica"
    },
    {
      id: 3,
      icon: "GlobeAltIcon",
      title: "Sostenibilidad",
      description: "Comprometidos con soluciones ecológicas que respetan nuestro planeta"
    },
    {
      id: 4,
      icon: "UserGroupIcon",
      title: "Colaboración",
      description: "Trabajamos junto a nuestros clientes para materializar sus sueños espaciales"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="font-accent text-xl lg:text-2xl text-lcdream-gray-light font-accent-regular italic leading-relaxed text-center max-w-4xl mx-auto">
            La arquitectura no se trata solo de edificios—se trata de crear experiencias que mejoran la vida humana. Cada espacio cuenta una historia y cada diseño resuelve una necesidad humana.
          </p>
        </div>
