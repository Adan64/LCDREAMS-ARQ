        ...
        <div className="flex flex-wrap gap-2">
          {categories.map((category) => (
            <button
              ...
              className={`px-4 py-2 font-body text-sm font-body-semibold rounded-md transition-smooth ${
          ...
          <div className="flex items-center space-x-1 bg-muted rounded-md p-1">
            <button
              ...
              className={`p-2 rounded transition-smooth ${
                viewMode === 'grid' ?'bg-accent text-accent-foreground' :'text-text-secondary hover:text-accent'
              }`}
            ...
            <button
              ...
              className={`p-2 rounded transition-smooth ${
                viewMode === 'list' ?'bg-accent text-accent-foreground' :'text-text-secondary hover:text-accent'
              }`}
